...
**Важно:** Если лицензия уже активирована для того же магазина на другом устройстве, система автоматически разрешит переактивацию на новом устройстве (обновление компьютера).
...
**Важно:** Если лицензия уже активирована для того же магазина на другом устройстве, система автоматически разрешит переактивацию на новом устройстве (обновление компьютера). В этом случае ответ будет содержать сообщение "License reactivated on new device successfully".

---

### 7. Деактивация лицензии

**POST** `/api/v1/licenses/deactivate`

Деактивирует лицензию на текущем устройстве, позволяя активировать её на новом устройстве.
...
#### Ошибки:
- `400 Bad Request` - Неверные данные запроса
- `403 Forbidden` - Лицензия не принадлежит этому магазину
- `404 Not Found` - Лицензия не найдена

**Использование:** Вызывайте этот эндпоинт перед активацией лицензии на новом устройстве, если хотите явно деактивировать старое устройство. Обычно это не требуется, так как система автоматически разрешает переактивацию.
...
### 9. Получить информацию о лицензии
...
### 11. Генерация лицензии для магазина
